...
// ... other functions ...
    ...
    @GET("/events") // Assuming this is the correct endpoint to fetch all events
    fun getAllEvents(): Call<List<Event>> // Replace 'Event' with the actual model class for events
